...
var sdp = __webpack_require__(539);
...
module.exports = function () {
  ...
  function getCameraSpecsById(deviceId) {
              ...
              return chain.then(function (searchState) {
                if (searchState.found) {
                  ...
                  return window.navigator.mediaDevices
                    .getUserMedia(searchState.nextConstraint)
                    .then(
    ...
    return getFirstResolvingConstraint(facingModeConstraints).then(function (
      facingModeSpecs
    ) {
      return getFirstResolvingConstraint(widthConstraints).then(function (
        widthSpecs
      ) {
        return getFirstResolvingConstraint(heightConstraints).then(function (
          heightSpecs
        ) {
          return {
            deviceId: deviceId,
            facingMode:
              facingModeSpecs === null
                ? null
                : facingModeSpecs.video.facingMode.exact,
            width: widthSpecs === null ? null : widthSpecs.video.width.exact,
            height:
              heightSpecs === null ? null : heightSpecs.video.height.exact,
          };
        });
      });
    });
  ...
  function chooseCameras() {
    ...
    return devices
      .then(function (mediaDeviceInfoList) {
        var videoDeviceIds = mediaDeviceInfoList
  ...
  function initialize(success, error) {
    if (scanWorker === null) {
      ...
      const original__webpack_public_path__ = __webpack_require__.p;

      const worker_public_path = window.QRSCANNER_WORKER_PUBLIC_PATH || null
      if (worker_public_path !== null) {
        __webpack_require__.p = worker_public_path;
      }

      scanWorker = new Worker(
        new URL(/* webpackChunkName: 'worker' */ /* worker import */ __webpack_require__.p + __webpack_require__.u(348), __webpack_require__.b)
      );

      __webpack_require__.p = original__webpack_public_path__;
    }
...
function QRScanner() {
  var createQRScannerAdapter = __webpack_require__(938);
  var createQRScannerInternal = __webpack_require__(272);
